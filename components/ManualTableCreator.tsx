...
export default function ManualTableCreator({ onConfirm, onCancel }: ManualTableCreatorProps) {
    ...
    return (
        ...
        >
            ...
            <div className="bg-white border-4 border-black rounded-[2.5rem] shadow-neo-lg overflow-hidden flex flex-col min-h-[400px]">
                        ...
                        <thead>
                            <tr className="border-b-4 border-black bg-black/5">
                                ...
                                <th className="p-4 w-20">
                                    <button 
                                        onClick={addColumn}
                                        className="p-3 bg-white border-3 border-black rounded-xl hover:bg-primary hover:text-white transition-all transform hover:rotate-12"
                                        title="Add Column"
                                    >
            ...
            <div className="flex items-center gap-4 p-6 bg-yellow-100 border-4 border-black rounded-3xl">
                <div className="p-3 bg-black text-white rounded-xl">
                    <Layout className="w-6 h-6" />
                </div>
                <p className="font-bold text-sm text-black/70">
                    <span className="font-black text-black">Pro Tip:</span> You can type numbers or text. Numbers will be automatically detected for charting!
                </p>
            </div>
        </motion.div>
    );
