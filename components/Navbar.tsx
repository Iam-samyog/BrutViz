...
export const Navbar: React.FC<NavbarProps> = ({ onHistoryClick }) => {
    return (
        <nav className="w-full border-b-4 border-black bg-black">
            <div className="max-w-7xl mx-auto p-4 md:p-6 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4 text-white">
                    ...
                    <a href="#" className="hidden sm:block text-sm font-black hover:text-primary transition-colors">Documentation</a>
